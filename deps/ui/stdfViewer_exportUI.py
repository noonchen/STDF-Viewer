...
class Ui_exportUI(object):
    def setupUi(self, exportUI):
        ...
        self.RawData_cb = QtWidgets.QCheckBox(self.content_selection)
        self.RawData_cb.setChecked(True)
        self.RawData_cb.setObjectName("RawData_cb")
...
"border: 1px solid rgb(40, 0, 0);}")
    ...
    def retranslateUi(self, exportUI):
        ...
        self.RawData_cb.setText(_translate("exportUI", "Raw Data"))
        ...
        self.Cancel.setText(_translate("exportUI", "Cancel"))
