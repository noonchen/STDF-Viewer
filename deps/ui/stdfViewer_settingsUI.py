...
"}")
        ...
        self.testIDTypecomboBox = QtWidgets.QComboBox(self.scrollAreaWidgetContents_3)
        self.testIDTypecomboBox.setObjectName("testIDTypecomboBox")
        self.testIDTypecomboBox.addItem("")
        self.testIDTypecomboBox.addItem("")
        self.gridLayout.addWidget(self.testIDTypecomboBox, 4, 3, 1, 1)
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 506, 277))
        ...
        self.axisModeCombobox = QtWidgets.QComboBox(self.scrollAreaWidgetContents_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.axisModeCombobox.sizePolicy().hasHeightForWidth())
        self.axisModeCombobox.setSizePolicy(sizePolicy)
        self.axisModeCombobox.setObjectName("axisModeCombobox")
        self.axisModeCombobox.addItem("")
        self.axisModeCombobox.addItem("")
        self.horizontalLayout_2.addWidget(self.axisModeCombobox)
        ...
        self.showRefLine = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_5)
        self.showRefLine.setObjectName("showRefLine")
        self.gridLayout_4.addWidget(self.showRefLine, 0, 0, 1, 1)
...
"border: 1px solid rgb(50, 50, 50);}")
    ...
    def retranslateUi(self, Setting):
        ...
        self.label_11.setText(_translate("Setting", "Test Identifier:"))
        self.testIDTypecomboBox.setItemText(0, _translate("Setting", "Number + Name"))
        self.testIDTypecomboBox.setItemText(1, _translate("Setting", "Number Only"))
        ...
        self.label_10.setText(_translate("Setting", "Axis Mode"))
        self.axisModeCombobox.setItemText(0, _translate("Setting", "X: Original; Y: Theoretical"))
        self.axisModeCombobox.setItemText(1, _translate("Setting", "X: Theoretical; Y: Original"))
        self.showRefLine.setText(_translate("Setting", "Show Refernece Line"))
